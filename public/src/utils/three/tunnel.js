(function(window, THREE) {
    ...
    Tunnel.prototype.createMesh = function(texture) {
        ...
        // 得到渐进变化的点
        this.originVertices = geometry.vertices = this.curve.getPoints(70);
    ...
    Tunnel.prototype.initAnimation = function() {
        ...
        var hyperSpace = new TimelineMax({
            ...
            onComplete: function() {
                ...
                if (app.classList) app.classList.remove("hide");
                else {
    ...
    Tunnel.prototype.render = function() {
        if (this.splineMesh.geometry.vertices === this.originVertices && this.flag) {
            // this.splineMesh.geometry.vertices = this.originVertices;
