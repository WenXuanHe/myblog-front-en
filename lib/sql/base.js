...
//`title` VARCHAR(50) NOT NULL , `lastModified` DATETIME NOT NULL , `isDelete` INT(2) NOT NULL ) ENGINE = InnoDB;
//新建articles表
//CREATE TABLE `blog`.`articles` ( `id` VARCHAR(20) NOT NULL , `userID` VARCHAR(20) NOT NULL , `workID` VARCHAR(20) NOT NULL ,
// `title` VARCHAR(100) NOT NULL , `content` TEXT NOT NULL , `lastModified` DATETIME NOT NULL , `isDelete` INT(2) NOT NULL ) ENGINE = InnoDB;
// 创建user表
